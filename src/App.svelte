...
//   onMount(async () => {
//     let lib = await import("ipfs-http-client");
//     client = new lib.create("https://ipfs.infura.io:5001/api/v0");
//   });
...
//     console.log(fileUrl);
//     const a = await fetch(
//       `http://ipfs.infura.io:5001/api/v0/dag/get?arg=${filePath}`,
//       {
//         method: "POST",
//       }
//     )
...
//       .then((data) => {
//         var blob = new Blob(
//           [new Uint8Array(data?.value != undefined ? data.value : [])],
//           { type: "audio/mp3" }
//         );
//         console.log(blob);
